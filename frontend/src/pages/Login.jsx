  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-white border border-slate-100/80 p-8 sm:p-12 rounded-[2rem] w-full max-w-[440px] relative z-10 space-y-6 shadow-[0_20px_50px_rgba(15,47,87,0.06)]"
      >
        {viewMode === 'login' ? (
          <>
            <motion.div variants={itemVariants} className="text-center space-y-3 flex flex-col items-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-[#0B53FA]/5 border border-[#0B53FA]/10 rounded-2xl mb-1 shadow-sm">
                <Shield className="w-8 h-8 text-[#0B53FA] fill-[#0B53FA]/10 stroke-[2]" />
              </div>
              ...
              <motion.div variants={itemVariants} className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-[#0B53FA] hover:text-[#0944CD] font-bold text-[11px] transition-colors cursor-pointer border-none bg-transparent"
                  >
                    Forgot?
                  </button>
                </div>
          ...
          <>
            ...
            <motion.div variants={itemVariants} className="text-center text-xs font-semibold text-slate-500">
              <button
                ...
                className="inline-flex items-center gap-1.5 text-[#0B53FA] hover:text-[#0944CD] font-bold transition-colors cursor-pointer border-none bg-transparent"
              >
